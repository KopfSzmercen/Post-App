...
var register = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var password, confirmPassword, hashedPassword, error_1, err;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!validator_1.default.isLength(confirmPassword, { min: 5, max: 15 })) {
                    throw {
                        success: false,
                        errors: {
                            confirmPassword: {
            ...
            case 2:
                ...
                return [4 /*yield*/, index_1.default.create(__assign(__assign({}, data), { password: hashedPassword, friends: [], likedPosts: [], postsCreated: [], messages: [] }))];
            case 3:
                _a.sent();
